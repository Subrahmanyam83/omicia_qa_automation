...
class ClinicalReporterModule extends Module {
    ...
    static content = {
        ...
        noReportsFound(required: false)      { $("div#nothing-found", text: contains("No reports founds: clear your filter or create a new report.")) }
        ...
        geneBasedOnRelationship              { String relationship -> $(".genomes").children().filter(text: contains(relationship)) }
