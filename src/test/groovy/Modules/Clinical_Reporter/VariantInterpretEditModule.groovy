...
class VariantInterpretEditModule extends Module {
    ...
    static content = {
        ...
        citationAddedConfirmation {
            $("div.abstract", title: contains("The importance of an innervated and intact antrum and pylorus in preventing postoperative duodenogastric reflux"))
        }
        ...
        currentVariantClassificationDropDownValue {
            $("div.classification .btn-default .filter-option.pull-left").text()
        }
        currentConditionTextFieldValue { $("") }
        ...
        /*Variant Evidence*/
        copyToVariantInterpretationAndDescritpion {
            $(".btn.btn-info.copy.pull-right.copy-clinvar.padding-both-sides")[0]
        }
